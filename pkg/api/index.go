...
func (hs *HTTPServer) setIndexViewData(c *models.ReqContext) (*dtos.IndexViewData, error) {
	...
	if hasEditPermissionInFoldersQuery.Result {
		...
		children = append(children, &dtos.NavLink{Text: "Import", SubTitle: "Import dashboard from file or ThingSPIN.com", Id: "import", Icon: "import", Url: setting.AppSubUrl + "/dashboard/import"})
