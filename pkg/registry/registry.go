...
// are expected to fulfill to be started within ThingSPIN.
type Service interface {

	// Init is called by ThingSPIN main process which gives the service
...
type BackgroundService interface {
	...
	// to subscribe to ctx.Done() so the service can be notified when ThingSPIN shuts down.
