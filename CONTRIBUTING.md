# Contributing to ThingSPIN

Thank you for your interest in contributing to ThingSPIN! We welcome all people who want to contribute in a healthy and constructive manner within our community. To help us create a safe and positive community experience for all, we require all participants to adhere to the [Code of Conduct](CODE_OF_CONDUCT.md).

This document is a guide to help you through the process of contributing to ThingSPIN.

## Become a contributor

You can contribute to ThingSPIN in several ways. Here are some examples:

- Contribute to the ThingSPIN codebase.
- Report and triage bugs.
- Develop community plugins and dashboards.
- Write technical documentation and blog posts, for users and contributors.
- Organize meetups and user groups in your local area.
- Help others by answering questions about ThingSPIN.
...
If you have an idea of how to improve ThingSPIN, submit an [enhancement request](https://github.com/grafana/grafana/issues/new?labels=type%3A+feature+request&template=2-feature_request.md).

We want to make ThingSPIN accessible to even more people. Submit an [accessibility issue](https://github.com/grafana/grafana/issues/new?labels=type%3A+accessibility&template=3-accessibility.md) to help us understand what we can improve.
...
It's important to us to help these users, and we'd love your help. Sign up to our [community site](https://community.grafana.com/), and start helping other ThingSPIN users by answering their questions.

### Your first contribution

Unsure where to begin contributing to ThingSPIN? Start by browsing issues labeled `beginner friendly` or `help wanted`.
...
- Get started [developing plugins](https://grafana.com/docs/plugins/developing/development/) for ThingSPIN.
