...
Besides the wide range of visualizations and data sources that are available immediately after you install ThingSPIN, you can extend your ThingSPIN experience with _plugins_.

You can [install]({{< relref "installation.md" >}}) one of the plugins built by the ThingSPIN community, or [build one yourself]({{< relref "../developers/plugins/_index.md" >}}).

ThingSPIN supports three types of plugins: [panels](https://grafana.com/grafana/plugins?type=panel), [data sources](https://grafana.com/grafana/plugins?type=datasource), and [apps](https://grafana.com/grafana/plugins?type=app).
...
Data source plugins communicate with external sources of data and return the data in a format that ThingSPIN understands. By adding a data source plugin, you can immediately use the data in any of your existing dashboards.
