...
- **scale**: numeric value to configure device scale factor. Default is 1. Use a higher value to produce more detailed images (higher DPI). Supported in ThingSPIN v7.0+.
...
Below there should be an interactive ThingSPIN graph embedded in an iframe:
