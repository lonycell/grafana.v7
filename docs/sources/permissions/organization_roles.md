...
description = "ThingSPIN Organization Roles Guide "
...
This role can be tweaked via ThingSPIN server setting [editors_can_admin]({{< relref "../installation/configuration.md#editors_can_admin" >}}). If you set this to true users
...
This role can be tweaked via ThingSPIN server setting [viewers_can_edit]({{< relref "../installation/configuration.md#viewers-can-edit" >}}). If you set this to true users
...
Useful for public ThingSPIN installations where you want anonymous users to be able to edit panels and queries but not save or create new dashboards.
