+++
title = "What's new in ThingSPIN v4.6"
description = "Feature and improvement highlights for ThingSPIN v4.6"
...
# What's new in ThingSPIN v4.6

ThingSPIN v4.6 brings many enhancements to Annotations, Cloudwatch and Prometheus. It also adds support for Postgres as metric and table data source!
...
ThingSPIN v4.6 now ships with a built-in data source plugin for Postgres. Have logs or metric data in Postgres? You can now visualize that data and
...
* **Dataproxy**: Allow ThingSPIN to renegotiate tls connection [#9250](https://github.com/grafana/grafana/issues/9250)
