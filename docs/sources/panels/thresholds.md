...
On visualizations that support it, ThingSPIN sets default threshold values of:
* 80 = red
* Base = green
* Mode = Absolute
...
You can add as many thresholds to a panel as you want. ThingSPIN automatically sorts thresholds from highest value to lowest.
...
1. ThingSPIN adds a threshold with suggested numerical and color values.
...
1. Fill in as many fields as you want. Only the **T1** fields are required.
   * **T1 -** Both values are required to display a threshold.
     ...
     * **Value -** Enter a threshold value. ThingSPIN draws a threshold line along the Y-axis at that value.
