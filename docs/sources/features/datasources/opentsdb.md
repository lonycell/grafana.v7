+++
title = "Using OpenTSDB in ThingSPIN"
description = "Guide for using OpenTSDB in ThingSPIN"
...
# Using OpenTSDB in ThingSPIN

ThingSPIN ships with advanced support for OpenTSDB.
...
ThingSPIN's OpenTSDB data source supports template variable queries. This means you can create template variables
