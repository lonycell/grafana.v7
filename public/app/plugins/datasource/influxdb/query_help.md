...
#### Group by time
- Group by time is important, otherwise the query could return many thousands of datapoints that will slow down ThingSPIN
...
[ThingSPIN's InfluxDB Documentation](http://docs.grafana.org/features/datasources/influxdb)
