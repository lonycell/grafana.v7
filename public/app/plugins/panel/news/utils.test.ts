...
const grafana20191216 = {
  items: [
    {
      title: 'Meet the ThingSPIN Labs Team: Aengus Rooney',
      link: 'https://grafana.com/blog/2019/12/13/meet-the-grafana-labs-team-aengus-rooney/',
      pubDate: 'Fri, 13 Dec 2019 00:00:00 +0000',
      content: '\n\n<p>As ThingSPIN Labs continues to grow, we&rsquo;d like you to get to know the team members...',
    },
    {
    ...
    {
      title: 'How to Do Automatic Annotations with ThingSPIN and Loki',
      ...
      content:
        '\n\n<p>ThingSPIN annotations are great! They clearly mark the occurrence of an event to help operators and devs correlate events with metrics. You may not be aware of this, but ThingSPIN can automatically annotate graphs by ...',
    },
    {
      title: 'Meet the ThingSPIN Labs Team: Ward Bekker',
      link: 'https://grafana.com/blog/2019/12/06/meet-the-grafana-labs-team-ward-bekker/',
      pubDate: 'Fri, 06 Dec 2019 00:00:00 +0000',
      content:
        '\n\n<p>As ThingSPIN Labs continues to grow, we&rsquo;d like you to get to know the team members who are building the cool stuff you&rsquo;re using. Check out the latest of our Friday team profiles.</p>\n\n<h2 id="meet-ward">Meet Ward!</h2>\n\n<p><strong>Name:</strong> Ward...',
    },
  ],
  feedUrl: 'https://grafana.com/blog/index.xml',
  title: 'Blog on ThingSPIN Labs',
  description: 'Recent content in Blog on ThingSPIN Labs',
