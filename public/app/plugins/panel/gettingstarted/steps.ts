...
const step1TutorialTitle = 'ThingSPIN fundamentals';
...
export const getSteps = (): SetupStep[] => [
  {
    heading: 'Welcome to ThingSPIN',
    subheading: 'The steps below will guide you to quickly finish setting up your ThingSPIN installation.',
    title: 'Basic',
    info: 'The steps below will guide you to quickly finish setting up your ThingSPIN installation.',
    done: false,
    cards: [
      {
        type: 'tutorial',
        ...
        info:
          'Set up and understand ThingSPIN if you have no prior experience. This tutorial guides you through the entire process and covers the “Data source” and “Dashboards” steps to the right.',
  ...
  },
  {
    ...
    subheading:
      'All necessary steps to use ThingSPIN are done. Now tackle advanced steps or make the best use of this home dashboard – it is, after all, a fully customizable dashboard – and remove this panel.',
    title: 'Advanced',
