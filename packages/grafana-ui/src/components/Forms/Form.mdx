...
Form component provides a way to build simple forms at ThingSPIN. It is built on top of [react-hook-form](https://react-hook-form.com/) library and incorporates the same concepts while adjusting the API slightly.
